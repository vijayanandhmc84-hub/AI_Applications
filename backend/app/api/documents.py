...
async def upload_document(
    ...
    db.commit()
    db.refresh(document)
    logger.info("Created document ID: %s", document.id)
    await DocumentProcessor(db).process_document(file_path, document.id)
    # TODO: Trigger background processing
   # background_tasks.add_task(DocumentProcessor, document.id, file_path, db)
